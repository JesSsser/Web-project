        ...
        <div class="container">
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="descr" id="descr" maxlength="255">
                    </div>

                    <div class="mb-3">
                    <label for="code_categ" class="form-label">Catégorie:</label>
                     <select class="form-select" name="code_categ" id="code_categ">
                  <option value="" disabled selected>Select a category</option>
                     <?php
                        foreach ($categories as $category) {
                            echo '<option value="' . $category['code_categ'] . '">' . $category['lib_categ'] . '</option>';
                        }
                    ?>
                     </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="qte_stock" id="qte_stock">
                    </div>
                    <div class="mb-3">
