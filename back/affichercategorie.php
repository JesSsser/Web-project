<?php
    ...
    $listeCategorie = $CategC->afficherCategorie();
?>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $categorie['lib_categ']; ?></td>
                                    <td><?php echo $categorie['desc_categ']; ?></td>
                                    <td>
                                        <a href="modifiercategorie.php?code_categ=<?php echo $categorie['code_categ']; ?>">Modifier</a>
                                    </td>
                                    <td>
                                        <a href="SupprimerCategorie.php?code_categ=<?php echo $categorie['code_categ']; ?>">Supprimer</a>
                                    </td>
                                </tr>
                            <?php
                            }
