<?php
 ...
 if (isset($_POST["lib_categ"]) && isset($_POST["desc_categ"])) {
     $categorie = new categorie(
         $_POST["lib_categ"],
         $_POST["desc_categ"]
     );

     $categorieC->modifiercategorie($categorie, $code_categ);
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
		...
		<?php
			if (isset($_GET["code_categ"])){
				$categorie = $categorieC->recuperercategorie($_GET["code_categ"]);
...
<div class="container">
        <form action="" method="POST">
            ...
            <div class="mb-3">
                <label for="lib_categ" class="form-label">Libellé:</label>
                <input type="text" class="form-control" name="lib_categ" id="lib_categ" value="<?php echo $categorie['lib_categ']; ?>" maxlength="255">
            </div>

            <div class="mb-3">
                <label for="desc_categ" class="form-label">Description:</label>
                <textarea class="form-control" name="desc_categ" id="desc_categ" rows="4"><?php echo $categorie['desc_categ']; ?></textarea>
            </div>
