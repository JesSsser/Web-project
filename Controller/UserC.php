<?php
	...
	class UserC {
		...
		function ajouterUser($User){
			$sql="INSERT INTO utilisateur (nom, prenom, date_nais, email, adresse, password, num_tel, role) 
			VALUES (:nom, :prenom, :date_nais, :email, :adresse, :password, :num_tel, :role)";
			$db = config::getConnexion();
			try{
				$query = $db->prepare($sql);
				$query->execute([
		...
		function recupereremail($email){
			...
			try{
				$reponse = $db->prepare('SELECT email FROM utilisateur WHERE email = :email');
