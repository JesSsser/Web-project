...
if (isset($_POST["email"]) && isset($_POST["password"])) {
    if ($UserC->recupereremail($_POST["email"]) != "") {
        if ($a = $UserC->signin($_POST["password"], $_POST["email"]) != "") {
            ...
            $_SESSION["date_nais"] = $a["date_nais"];
            $_SESSION["email"] = $a["email"];
            $_SESSION["adresse"] = $a["adresse"];
            $_SESSION["password"] = $a["password"];
            $_SESSION["num_tel"] = $a["num_tel"];
            $_SESSION["active"] = $a["active"];
            $_SESSION["role"] = $a["role"];

            if ($_SESSION["role"] == "user") {
                header("location: afficherproduit.php"); // Redirection vers afficherproduit.php
                exit(); // Terminer l'exécution du script ici pour éviter toute sortie non désirée
            } else {
